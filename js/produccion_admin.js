		...
		function load(page){
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'./ajax/buscar_produccion_admin.php?action=ajax&page='+page+'&q='+q,
		...
		//Añado la lista
			...
			$.ajax({
				type: 'POST',
				url: './ajax/cita_form_tecnicos.php'
			})
			.done(function(tecnicos){
				$('#tecnicos').html(tecnicos) //llamo al div deco
			})
			.fail(function(){
				alert('Hubo un errror al cargar el tecnico')
			})
			
			//Si cambia la lista tambien cambia la acometida
			$('#proyecto').on('change', function(){
				//Almaceno la variable proyect y se la mando al php mediante post.
				var proyect = $('#proyecto').val()
				$.ajax({
					type: 'POST',
					url: './ajax/form_acometidas.php',
			...
			$('#tipo').on('change', function(){
				//Almaceno la variable proyect y se la mando al php mediante post.
				var long_aco = $('#tipo').val();
				var proyect = $('#proyecto').val();
				$.ajax({
					type: 'POST',
					url: './ajax/form_long_acometida.php',
					data: {'long_aco':long_aco,
									'proyect':proyect}
				})
				.done(function(proyecto){
					$('#long-acometida').html(proyecto)
				})
				.fail(function(){
					alert('Hubo un errror al cargar la long de acometida')
				})
			})
	  ...
	  function tipoInst(){ //Cambiar por otro tipo, if is select algo así
	    $.ajax({
	      type: 'POST',
		...
		$('#mod_tipo').on('change', function(){
			...
			.done(function(proyecto){
				$('#mod_long-acometida').html(proyecto)
			})
			.fail(function(){
				alert('Hubo un errror al cargar la long de acometida')
			})
	  ...
	  function tipoLong(){ //Cambiar por otro tipo, if is select algo así
	    $.ajax({
	      type: 'POST',
