  ...
  <body>
    ...
    <div class="container">
		...
		<div class="panel-heading">
			...
			<h4><i class='glyphicon glyphicon-user'></i> Administrar Usuarios</h4>
		</div>
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Introduce el Nombre del usuario" onkeyup='load(1);'>
							</div>
